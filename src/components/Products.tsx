const products = [
  {
    ...
    details: [
      '5% upfront fee (covers up to 30 days)',
      '+20% additional fee collected at closing',
      'Rapid wire transfer to title/escrow',
      'EMD returned to us if deal falls through',
    ],
  },
  {
    icon: '⚡',
    ...
    desc: 'Protect your spread and keep your assignment fee private. We fund the A-B leg so you can close A-B and B-C — at the same or different title company.',
    details: [
      'Starts at 1.5% — no upfront fee',
      'Same or different title companies',
      'Your margin stays completely private',
      'No charge if deal doesn\'t close',
    ],
  },
  {
    icon: '📊',
    ...
    desc: 'Layer seller carryback notes, DSCR loans, or other creative structures. We provide the transactional bridge capital to make complex stacked deals executable.',
    details: [
      'Starts at 2.5% — no upfront fee',
